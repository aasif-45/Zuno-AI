                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-400">
                      {Array.isArray(art.files) ? art.files.length : 0} {Array.isArray(art.files) && art.files.length === 1 ? "file" : "files"} included
                    </div>
                  </div>
                </div>

                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 text-xs font-medium text-white group-hover:bg-emerald-500 group-hover:text-black transition-colors">
                  <span>View Code</span>
